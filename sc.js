...
function processHTML(inputFilePath, outputFilePath) {
    try {
        const cssFiles = ['styles.css', 'css/all.min.css', 'css/all.css', 'css/brands.min.css', 'css/brands.css', 'css/fontawesome.min.css', 'css/fontawesome.css', 'css/regular.min.css', 'css/regular.css', 'css/solid.min.css', 'css/solid.css', 'css/svg-with-js.min.css', 'css/svg-withjs.css', 'css/v4-font-face.min.css', 'css/v4-font-face.css', 'v4-shims.css', 'v4-shims.min.css', 'v5-font-face.css', 'v5-font-face.min.css'].map(file => path.resolve(file));
