...
class MentalHealthWidget2x1 : AppWidgetProvider() {
    ...
    companion object {
        fun updateWidget(context: Context) {
            ...
            val ids = appWidgetManager.getAppWidgetIds(ComponentName(context, MentalHealthWidget2x1::class.java))
            val intent = Intent(context, MentalHealthWidget2x1::class.java)
